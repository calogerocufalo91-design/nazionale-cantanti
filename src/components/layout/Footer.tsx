    ...
    <footer className="bg-notte text-white">
      <Container className="py-16">
        <div className="grid gap-12 lg:grid-cols-[1.2fr_1fr_1fr]">
          ...
          <div>
            <p className="font-cond text-sm uppercase tracking-[0.2em] text-white/50">
              Newsletter
            </p>
            ...
            <address className="mt-8 not-italic text-sm text-white/60">
              {site.address.line1}
              <br />
              {site.address.line2}
              <br />
              <a
                ...
                className="text-azzurro-chiaro transition-colors hover:text-white"
              >
                {site.email}
              </a>
            </address>
